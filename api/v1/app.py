...
api.add_resource(StudentInGroupResource,
                 "/api/v1/groups/<int:group_id>/<int:student_id>")
api.add_resource(StudentsInGroupListResource,
                 "/api/v1/groups/<int:group_id>/students")
